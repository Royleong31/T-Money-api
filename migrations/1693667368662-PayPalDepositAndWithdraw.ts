...
export class PayPalDepositAndWithdraw1693667368662 implements MigrationInterface {
    name = 'PayPalDepositAndWithdraw1693667368662'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "pay_pal_deposit" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "paypal_checkout_id" character varying NOT NULL, "currency" character varying NOT NULL, "amount" numeric NOT NULL, "user_id" uuid NOT NULL, "fees" character varying NOT NULL, "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_897f92cd5cfb0c082afa374f650" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "pay_pal_withdraw" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "paypal_payment_id" character varying NOT NULL, "currency" character varying NOT NULL, "amount" numeric NOT NULL, "user_id" uuid NOT NULL, "fees" character varying NOT NULL, "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_53c03c0566185724acdbe837223" PRIMARY KEY ("id"))`);
